...
The main objective of the TADkit R package is to make the visualization of data associated with HiC analyses accessible to biologists without the need for bioinformatics skills. To this end, two pairs of functions (based on gviz and ggplot packages) have been created to visualize :
